...
namespace MontageServer.Controllers
{
    public class HomeController : Controller
    {
        ...
        public IActionResult Account()
        {
            ...
            return View(returnList);//_montageContext.AdobeClips.Where(y => _montageContext.ClipAssignments.Where(x => x.UserId == currentUserId).Any(z => z.ClipId == y.ClipId)).ToList());
        }
